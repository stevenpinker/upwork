...
export default function StandardBronze() {
        ...
        menuItems={[
          {
            ...
            onPress: () => {
              ...
              navigation.navigate("StandardBronzeLowProfit");
            },
          },
          {
            ...
            onPress: () => {
              setModalVisible(false);
              navigation.navigate("StandardBronzeHighProfit");
            },
          },
        ]}
      />
          ...
          <View style={styles.logoContainer}>
            <View style={styles.star}>
              <Image
                ...
                source={require("../../../assets/img/bronzeStar.png")}
              />
            </View>
          </View>
          ...
          <View style={styles.selectCart}>
            <View style={styles.product}>
              ...
              <TouchableOpacity
                ...
                onPress={() =>
                  navigation.navigate("StandardBronzeRestaurant")
                }
              >
            ...
            <View style={styles.product}>
              ...
              />
              <TouchableOpacity
              onPress={()=>navigation.navigate("StandardBronzeServiceProvider")}
              style={styles.productContainer}>
