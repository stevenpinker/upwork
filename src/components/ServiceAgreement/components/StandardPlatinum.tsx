...
export default function StandardPlatinum() {
        ...
        menuItems={[
          {
            ...
            onPress: () => {
              ...
              navigation.navigate("StandardPlatinumLowProfit");
          ...
          },
          {
            ...
            onPress: () => {
              setModalVisible(false);
               navigation.navigate("StandardPlatinumHighProfit");
            },
          },
        ]}
      />
          ...
          <View style={styles.logoContainer}>
            <View style={styles.star}>
              <Image
                ...
                source={require("../../../assets/img/platinumStar.png")}
              />
            </View>
          </View>
          ...
          <View style={styles.selectCart}>
            <View style={styles.product}>
              ...
              <TouchableOpacity
                ...
                onPress={() =>
                  navigation.navigate("StandardPlatinumRestaurant")
                }
              >
            ...
            <View style={styles.product}>
              ...
              onPress={()=>navigation.navigate("StandardPlatinumServiceProvider")}
              >
