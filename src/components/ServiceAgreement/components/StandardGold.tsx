...
export default function StandardGold() {
        ...
        menuItems={[
          {
            ...
            onPress: () => {
              ...
              navigation.navigate("StandardGoldLowProfit");
            },
          },
          {
            ...
            onPress: () => {
              setModalVisible(false);
              navigation.navigate("StandardGoldHighProfit")
            },
          },
        ]}
      />
          ...
          <View style={styles.logoContainer}>
            <View style={styles.star}>
              <Image
                ...
                source={require("../../../assets/img/goldstar.png")}
              />
            </View>
          </View>
          ...
          <View style={styles.selectCart}>
            <View style={styles.product}>
              ...
              <TouchableOpacity
                ...
                onPress={() =>
                  navigation.navigate("StandardGoldRestaurant")
                }
              >
            ...
            <View style={styles.product}>
              ...
              <TouchableOpacity
                style={styles.productContainer}
                onPress={() =>
                  navigation.navigate("StandardGoldServiceProvider")
                }
              >
