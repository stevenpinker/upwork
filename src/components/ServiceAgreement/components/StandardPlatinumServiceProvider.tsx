...
export default function StandardPlatinumServiceProvider() {
    ...
    return (
        <View style={styles.container}>
            ...
            <MainScreen title="Platinum" />
            <View style={styles.padding}>
                <View style={styles.dataContainer}>
                    <Text style={styles.restaurantText}>Service Provider</Text>
                    <View style={styles.star}>
                        <View style={styles.starIcon}>
                            <Text style={styles.tenText}>20%</Text>
                        </View>
                    </View>
                    <View style={styles.StarContainer}>
                        <View style={styles.discreption}>
                            <Entypo
                                ...
                                color={colors.black}
                            />
                            <Text style={styles.discreptionText}>One 1-3 min video</Text>
                        </View>
                        <View style={styles.discreption}>
                            <Entypo
                                name="dot-single"
                                ...
                                color={colors.black}
                            />
                            <Text style={styles.discreptionText}>3 products per month</Text>
                        </View>
                        <View style={styles.discreption}>
                            <Entypo
                                name="dot-single"
                                ...
                                color={colors.black}
                            />
                            <Text style={styles.discreptionText}>10K influencer(s) shout-out</Text>
                        </View>
                        <View style={styles.discreption}>
                            <Entypo
                                name="dot-single"
                                ...
                                color={colors.black}
                            />
                            <Text style={styles.discreptionText}>1 post+2 stories per week</Text>
                        </View>
                    </View>
                </View>
            </View>
