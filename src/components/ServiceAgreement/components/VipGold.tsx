...
export default function VipGold() {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.padding}>
        ...
        <View style={styles.dataContainer}>
          ...
          <Text style={styles.ChildText}>(Reel/TikToks/Shorts)</Text>
          <View style={styles.discreption}>
            <Feather
              name="check-circle"
              size={20}
          ...
          <View style={styles.discreption}>
            <Feather
              ...
              color={colors.deepSafroon}
            />
            <Text style={styles.discreptionText}>Coupon Marketing</Text>
          </View>
          <View style={styles.discreption}>
            <Feather
              name="check-circle"
              ...
              color={colors.deepSafroon}
            />
            <Text style={styles.discreptionText}>VIP Commercial Video</Text>
          </View>
          <Text style={styles.ChildText}>(3-5 minutes)</Text>
